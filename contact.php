        ...
        <div class="row gy-4 d-flex justify-content-end">
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>A108 zetland Street, UK, NY 532</p>
              </div>
            </div><!-- End Info Item -->
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Email:</h4>
                <p>zetland.lifecoach@gmail.com</p>
              </div>
            </div><!-- End Info Item -->
...
?>
            ...
            <form action="" method="POST">
              ...
              <br>
              <div class="text-center"><button type="submit" class="btn btn-primary" name="send_feedback">Send Message</button></div>
            </form>
