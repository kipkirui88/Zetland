...
$query = "UPDATE `program_page` SET `title` = '$get_title',`body` = '$get_body',`list1` = '$get_list1',`list2` = '$get_list2',`list3` = '$get_list3',`list4` = '$get_list4' WHERE `program_page`.`id` = 1";
...
$query = "UPDATE `program_page` SET `title` = '$get_title',`sub_title` = '$get_sub_title',`body` = '$get_body',`list1` = '$get_list1',`list2` = '$get_list2',`list3` = '$get_list3',`list4` = '$get_list4' WHERE `program_page`.`id` = 2";
$run_me = mysqli_query($conn,$query);
...
?>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <label>SUB-TITLE </label>
                                        <input type="text" class="form-control form-control" id="sub_title" name="sub_title" value="<?php echo $transRe['sub_title']; ?>"
                                            >
                                    </div>
    ...
    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="col-sm-12">
                                          <label>LIST 4 </label>
                                        <textarea type="text" class="form-control form-control" id="about" name="list4" rows="5" cols="50"
                            ...
                            <form class="user" method="POST" action="">
                                <div class="form-group row">
                                    ...
                                    <label>TITLE </label>
                                     ...
                                     <div class="col-sm-12">
                                          <label>BODY TEXT</label>
                                        <textarea type="text" class="form-control form-control" id="about"  name="body" rows="5" cols="50"
                                            ><?php echo $transRe['list2']; ?></textarea>
                                    </div>
                                </div>
