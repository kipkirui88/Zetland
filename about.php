    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4" data-aos="fade-up">
          <div class="col-lg-4">
            <img src="assets/img/me.jpg" class="img-fluid" style="height: 60vh;" alt="">
          </div>
          <div class="col-lg-8">
...
?>
                    ...
                    <i class="bi bi-check-circle-fill"></i> <?php echo $transRe['list2'] ?>
                     <br> <br>
          <?php echo $transRe['list3'] ?>
                    <br>
                 <?php echo $transRe['list4'] ?>
                    </p>
                  </div>
                </div><!-- End slide item -->
<?php
